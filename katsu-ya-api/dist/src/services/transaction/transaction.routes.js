...
const transaction_controller_1 = __importDefault(
    ...
    (0, handler_1.requestHandler)(
        (req, res) =>
            __awaiter(void 0, void 0, void 0, function* () {
                ...
                const rs = yield transaction.editTransaction(
                    id,
                    details,
                    idUser
                );
    ...
    (0, handler_1.requestHandler)(
        (req, res) =>
            __awaiter(void 0, void 0, void 0, function* () {
                ...
                const idUser = res.locals.userInfo.id;
                const rs = yield transaction.createTransactionCart(
    ...
    (0, handler_1.requestHandler)(
        (req, res) =>
            __awaiter(void 0, void 0, void 0, function* () {
                ...
                const rs = yield transaction.finishTransactionCart(
                    paid,
                    transactionCart
                );
                return rs;
    ...
    (0, handler_1.requestHandler)(
        (req, res) =>
            __awaiter(void 0, void 0, void 0, function* () {
                ...
                const rs = yield transaction.getTransactions(
                    startDate,
                    endDate
                );
                return rs;
    ...
    (0, handler_1.requestHandler)(
        (req, res) =>
            __awaiter(void 0, void 0, void 0, function* () {
                ...
                const rs = yield transaction.getOrderByTable(
                    parseInt(idTable) || 0
                );
                return rs;
            }),
...
router.post(
    ...
    (0, handler_1.requestHandler)(
        (req, res) =>
            __awaiter(void 0, void 0, void 0, function* () {
                (0,
                validate_1.validate)(["idCart", "firstName", "email", "phone"], req.body);
                const { idCart, firstName, email, phone } = req.body;
                const rs = yield transaction.getPaymentToken(
                    idCart,
                    firstName,
                    email,
                    phone
