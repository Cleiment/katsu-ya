...
router.post("/pay/get-token", (0, handler_1.requestHandler)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    (0, validate_1.validate)(["idCart", "firstName", "email", "phone", "finishLink"], req.body);
    const { idCart, firstName, email, phone, finishLink } = req.body;
    const rs = yield transaction.getPaymentToken(idCart, firstName, email, phone, finishLink);
    return rs;
}), [env_config_1.Roles.manager, env_config_1.Roles.cashier, env_config_1.Roles.guest]));
