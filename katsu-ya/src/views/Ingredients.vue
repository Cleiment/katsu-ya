...
import { modalSize, type Ingredient } from '@/tools/types'
...
const { getAll, createIngredient, editIngredient } = ingredientStore
...
//     if (selectedPage.value != ingredientStore.pages) {
